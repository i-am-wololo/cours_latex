...
\begin{itemize}
    ...
    DAqui est la matrice TA
modifiée par l'algorithme de Gauss et qui est donc à présent une matrice diagonale.
SAqui est la matrice IA sur laquelle on a appliqué l'ensemble des transformations effectuées sur TA. En particulier on a SA×A=DA
\end{itemize}
